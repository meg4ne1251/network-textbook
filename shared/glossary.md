...
- **関連RFC**: RFC 2597
- **関連用語**: DSCP、PHB、EF、DiffServ、RED / WRED
...
- **関連用語**: テールドロップ、RED / WRED、CoDel / fq_codel、バッファブロート、輻輳
...
- **初出章**: `07_qos/01_qos_basics.md`
- **関連RFC**: RFC 2475
- **関連用語**: 輻輳、ジッタ、ベストエフォート、DiffServ、IntServ、DSCP、AQM
...
- **関連用語**: AQM、AF、テールドロップ、CoDel / fq_codel
